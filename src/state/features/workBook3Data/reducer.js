...
const initialState = {
    ...
    isWorkBook3DataLoaded: false,        // загрузились ли данные в стейт
    isWorkBook3DataLoading: false,       // загружаются ли данные в стейт по моменту
};

const workBook3DataReducer = (state = initialState, action) => {
    switch (action.type) {

        case WORK_BOOK_3_DATA: {
            const superState = {
                ...state,

                otstSheetData: action.workBook3DataObject.otstSheetData.map(item => {
                    return {
                ...
                ocKmSheetData: action.workBook3DataObject.ocKmSheetData.map(item => {
                    return {
                        "KM": +item["KM"],
        ...
        case IS_WORK_BOOK_3_DATA_LOADED: {
            const superState = {
                ...state,
                isWorkBook3DataLoaded: action.isWorkBook3DataLoaded
            };
            return superState;
        }

        case IS_WORK_BOOK_3_DATA_LOADING: {
            const superState = {
                ...state,
                isWorkBook3DataLoading: action.isWorkBook3DataLoading
            };
            return superState;
        }
...
export default workBook3DataReducer;